...
$product = [
    'id' => 25,
    'name' => $langs['seo_basic_title'] ?? 'SEO Basic',
    'price' => 299.99,
    'img' => '../../assets/img/seo.png',
    'ref' => $langs['seo_basic_ref'] ?? 'seo-basic',
];
...
<head>
    ...
    <meta name="description" content="<?= htmlspecialchars($langs['seo_basic_meta_desc'] ?? 'Boostez votre visibilité sur Google avec notre Pack SEO Basic. Inclus : audit SEO technique complet, optimisation des balises et rapport de positionnement de votre site.') ?>">
    <meta name="keywords" content="<?= htmlspecialchars($langs['seo_basic_meta_keywords'] ?? 'seo basic, audit seo, optimisation google, referencement naturel, visibilite web, trafic google, sazulis') ?>">
...
<main style="background:transparent;box-shadow:none;border-radius:0;margin-bottom:2em;">
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                <?= $langs['seo_basic_why'] ?? 'Pack SEO Basic pour améliorer la visibilité de votre site sur Google et booster votre trafic naturel.' ?>
            </div>
    ...
    <section style="background: none; padding: 2em 0 1em 0;">
        <ul class="hero-devweb-list" style="display:flex;flex-wrap:wrap;justify-content:center;gap:2em;list-style:none;padding:0;margin:0 auto 0 auto;max-width:900px;">
            <li><?= $langs['seo_basic_inclus1'] ?? 'Optimisation des balises et contenus' ?></li>
            <li><?= $langs['seo_basic_inclus2'] ?? 'Analyse technique du site' ?></li>
            <li><?= $langs['seo_basic_inclus3'] ?? 'Soumission aux moteurs de recherche' ?></li>
            <li><?= $langs['seo_basic_inclus4'] ?? 'Rapport de positionnement' ?></li>
            <li><?= $langs['seo_basic_inclus5'] ?? 'Conseils personnalisés' ?></li>
            <li><?= $langs['seo_basic_inclus6'] ?? 'Support technique SEO' ?></li>
        </ul>
    </section>
    <section style="max-width:700px;margin:2em auto 0;padding:20px;background:#f8f8f8;border-radius:10px;box-shadow:0 2px 8px #0001;">
        ...
        <table style="width:100%;border-collapse:collapse;background:#fffaf0;border:1px solid #ffe066;color:#2a7ae2;font-size:1em;border-radius:8px;overflow:hidden;">
            ...
            <tbody>
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Audit SEO complet</td>
                ...
                <tr>
                    <td style="padding:8px;border:1px solid #ffe066;">Optimisation technique</td>
                ...
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Rapport de positionnement</td>
                    <td style="padding:8px;border:1px solid #ffe066;">1 rapport inclus</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">49,99&nbsp;€</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">49,99&nbsp;€</td>
                </tr>
            </tbody>
            <tfoot>
                <tr style="background:#ffe066;font-weight:bold;color:#222;">
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">299,98&nbsp;€</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">399,98&nbsp;€</td>
                </tr>
            </tfoot>
        </table>
        <div style="background:#fffaf0;border:1px solid #ffe066;border-radius:8px;padding:14px 18px;margin-top:14px;color:#2a7ae2;font-size:1em;text-align:left;">
            Nos offres SEO regroupent tous les services essentiels pour améliorer votre visibilité en ligne, à un tarif préférentiel. Audit, optimisation et suivi inclus. Le tarif “sans offre” correspond au prix standard si chaque service était acheté séparément. Packs conçus pour simplicité, économies et résultats.
        </div>
    </section>
    ...
    <section style="background:#eaf4ff;border-radius:18px;padding:2em 1.5em;box-shadow:0 4px 24px rgba(42,122,226,0.08);margin:2em auto 2em auto;max-width:900px;">
        ...
        <p style="color:#222;font-size:1.05rem;line-height:1.6;">
            <?= $langs['seo_basic_desc'] ?? 'Ce pack SEO Basic comprend l’audit complet de votre site, l’optimisation technique, la soumission aux moteurs de recherche et un rapport détaillé. Idéal pour les sites qui débutent ou souhaitent améliorer leur référencement naturel sans surcoût.' ?>
        </p>
    </section>
    <section style="background:#fffbe6;border-radius:18px;padding:2em 1.5em;box-shadow:0 4px 24px rgba(255,224,102,0.08);margin:2em auto 2em auto;max-width:900px;border:2px dashed #ffe066;">
        ...
        <ul style="color:#e22a2a;font-size:1.05rem;line-height:1.6;list-style:disc inside;margin:0 0 0 18px;">
            <li><?= $langs['seo_basic_non_inclus1'] ?? 'Campagnes publicitaires Google Ads' ?></li>
            <li><?= $langs['seo_basic_non_inclus2'] ?? 'Rédaction de contenus premium' ?></li>
            <li><?= $langs['seo_basic_non_inclus3'] ?? 'Suivi SEO mensuel' ?></li>
        </ul>
    </section>
</main>
<footer>
