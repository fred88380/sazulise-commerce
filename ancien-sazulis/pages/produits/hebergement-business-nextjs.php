...
$product = [
    ...
    'ref' => 'hebergement-business-nextjs',
];
...
<head>
    ...
    <meta name="description" content="Hébergement Node.js haut de gamme pour les infrastructures Next.js d’entreprise. Performances maximales, architecture SSR/ISR optimisée et support dédié par Sazulis.">
    <meta name="keywords" content="hebergement nextjs business, serveur nodejs entreprise, deploiement nextjs ssr, infrastructure react, cloud professionnel, sazulis, epinal, vosges">
    ...
    <script type="application/ld+json">
    {
      ...
      "image": "https://<?= $_SERVER['HTTP_HOST'] ?>/assets/img/hebergement.jpg",
      "description": "Hébergement Next.js business haut de gamme pour entreprise. Optimisé pour l'architecture SSR et ISR avec Node.js, support dédié et sécurité avancée.",
...
<main>
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                ...
                <div style="color:#2a7ae2;font-size:1.1em;font-weight:600;margin-top:4px;">Hébergement optimisé pour Next.js, évolutif &amp; sécurisé pour entreprises</div>
            </div>
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                Hébergement Next.js business performant, sécurisé et évolutif, idéal pour les entreprises exigeantes.<br>
                Hébergement Next.js business avec support dédié, sécurité avancée et performances optimales.
            </div>
        </div>
    </section>
    ...
    <section style="background: none; padding: 2em 0 1em 0;">
        <ul class="hero-devweb-list" style="display:flex;flex-wrap:wrap;justify-content:center;gap:2em;list-style:none;padding:0;margin:0 auto 0 auto;max-width:900px;">
            <li>Hébergement business Next.js sur-mesure</li>
            <li>Support dédié</li>
            <li>Sauvegardes régulières</li>
            <li>Hébergement 1 mois offert</li>
    ...
    <section style="max-width:700px;margin:2em auto 0;padding:20px;background:#f8f8f8;border-radius:10px;box-shadow:0 2px 8px #0001;">
        ...
        <table style="width:100%;border-collapse:collapse;background:#fffaf0;border:1px solid #ffe066;color:#2a7ae2;font-size:1em;border-radius:8px;overflow:hidden;">
            ...
            <tbody>
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Hébergement business Next.js</td>
                    <td style="padding:8px;border:1px solid #ffe066;">1 an</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">579,98 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">699,00 €</td>
                </tr>
                <tr>
                    <td style="padding:8px;border:1px solid #ffe066;">Sauvegardes régulières</td>
                ...
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Support dédié</td>
                    <td style="padding:8px;border:1px solid #ffe066;">Incluse</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">0,00 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">80,00 €</td>
                </tr>
            </tbody>
            <tfoot>
                <tr style="background:#ffe066;font-weight:bold;color:#222;">
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">579,98 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">839,00 €</td>
                </tr>
            </tfoot>
        </table>
        <div style="background:#fffaf0;border:1px solid #ffe066;border-radius:8px;padding:14px 18px;margin-top:14px;color:#2a7ae2;font-size:1em;text-align:left;">
            Cette offre inclut l'hébergement business Next.js, les sauvegardes régulières et le support dédié. Le tarif “sans offre” correspond au prix standard si chaque service était acheté séparément. Idéal pour la performance et la sécurité de vos projets Next.js en entreprise.
        </div>
    </section>
