...
$product = [
    ...
    'ref' => 'hebergement-premium-nextjs',
];
...
<head>
    ...
    <meta name="description" content="Hébergement Next.js haut de gamme optimisé SSR et ISR. Bande passante illimitée, architecture Node.js de pointe et protection DDoS par Sazulis.">
    <meta name="keywords" content="hebergement nextjs premium, serveur ssr nextjs, deploiement next.js, expert nodejs, sazulis, epinal, vosges">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Hébergement Next.js premium avec architecture Node.js haut de gamme, optimisé pour le SSR, l'ISR, incluant une sécurité avancée et un support expert.",
...
<main>
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                ...
                <div style="color:#2a7ae2;font-size:1.1em;font-weight:600;margin-top:4px;">Hébergement optimisé pour Next.js, performance &amp; sécurité maximale</div>
            </div>
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                Hébergement Next.js premium ultra-rapide, sécurisé et avec support expert, pour les projets les plus exigeants.<br>
                Hébergement Next.js premium avec sécurité avancée, rapidité et support expert.
            </div>
        </div>
    </section>
    ...
    <section style="background: none; padding: 2em 0 1em 0;">
        <ul class="hero-devweb-list" style="display:flex;flex-wrap:wrap;justify-content:center;gap:2em;list-style:none;padding:0;margin:0 auto 0 auto;max-width:900px;">
            <li>Hébergement premium Next.js sur-mesure</li>
    ...
    <section style="max-width:700px;margin:2em auto 0;padding:20px;background:#f8f8f8;border-radius:10px;box-shadow:0 2px 8px #0001;">
        ...
        <table style="width:100%;border-collapse:collapse;background:#fffaf0;border:1px solid #ffe066;color:#2a7ae2;font-size:1em;border-radius:8px;overflow:hidden;">
            ...
            <tbody>
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Hébergement premium Next.js</td>
                    <td style="padding:8px;border:1px solid #ffe066;">1 an</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">1 159,96 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">1 399,00 €</td>
                </tr>
                <tr>
                ...
                <tr style="background:#fffbe6;">
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;">Incluse</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">0,00 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">180,00 €</td>
                </tr>
            </tbody>
            <tfoot>
                <tr style="background:#ffe066;font-weight:bold;color:#222;">
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">1 159,96 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">1 699,00 €</td>
                </tr>
            </tfoot>
        </table>
        <div style="background:#fffaf0;border:1px solid #ffe066;border-radius:8px;padding:14px 18px;margin-top:14px;color:#2a7ae2;font-size:1em;text-align:left;">
            Cette offre inclut l'hébergement premium Next.js, les sauvegardes régulières et le support expert. Le tarif “sans offre” correspond au prix standard si chaque service était acheté séparément. Idéal pour la performance et la sécurité de vos projets Next.js.
        </div>
    </section>
