...
$stmt = $pdo->prepare('SELECT * FROM produits WHERE id = 23');
$prodRow = $stmt->execute() ? $stmt->fetch() : null;

$product = [
    'id' => 22,
    'name' => 'Site vitrine pack-starter Next.js',
    'price' => $prodRow ? $prodRow['prix'] : 2899.10,
    'img' => '../../assets/img/vitrine-site.png',
    'ref' => 'site-vitrine-pack-starter-nextjs',
];
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($product['name']) ?> - Vitesse &amp; Performance - Sazulis</title>
    <meta name="description" content="Découvrez notre Pack Starter Next.js pour site vitrine. Alliez la puissance de React et Next.js pour un site vitrine professionnel ultra-rapide, sécurisé et à prix avantageux.">
    <meta name="keywords" content="pack starter nextjs, site vitrine next.js, developpement react, site web rapide, creation site vitrine performant, sazulis">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Pack de démarrage Next.js complet pour concevoir un site vitrine professionnel performant, évolutif et nativement optimisé pour le SEO.",
    ...
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                Pack de démarrage Next.js pour site vitrine professionnel, moderne, rapide et sécurisé.
            </div>
            <div style="margin-top:2em;display:flex;flex-direction:column;align-items:center;gap:0.5em;">
                <div style="display:flex;align-items:baseline;gap:1em;justify-content:center;flex-wrap:wrap;">
                    <span class="prix-barre" style="font-size:1.2em;color:#174a7c;text-decoration:line-through;font-weight:700;">
                        <?= number_format(5399.10, 2, ',', ' ') ?> €
                    </span>
                    ...
                    <span class="fiche-economie" style="color:#388e3c;font-weight:600;font-size:1em;margin-left:0.5em;">Économie : <?= number_format(5399.10 - $product['price'], 2, ',', ' ') ?> €</span>
                </div>
