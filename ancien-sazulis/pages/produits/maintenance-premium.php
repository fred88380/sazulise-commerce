...
<head>
    ...
    <meta name="description" content="Maintenance haut de gamme et sécurité maximale pour plateformes critiques. Audits réguliers, interventions illimitées et support expert 24/7 par Sazulis.">
    <meta name="keywords" content="maintenance premium, cybersecurite, audit securite web, support expert 24/7, infogerance vosges, sazulis">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Maintenance premium avec audits réguliers, interventions illimitées et reporting avancé pour garantir la performance et la sécurité maximale de vos plateformes web.",
...
<main>
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                ...
                <div style="color:#2a7ae2;font-size:1.1em;font-weight:600;margin-top:4px;">Sécurité absolue, infogérance experte &amp; disponibilité maximale</div>
            </div>
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                Maintenance haut de gamme, sécurité maximale, support expert et interventions prioritaires pour sites critiques.<br>
                Maintenance premium avec audits réguliers, interventions illimitées et reporting avancé pour garantir la performance.
            </div>
        </div>
    </section>
    ...
    <section style="max-width:700px;margin:2em auto 0;padding:20px;background:#f8f8f8;border-radius:10px;box-shadow:0 2px 8px #0001;">
        ...
        <table style="width:100%;border-collapse:collapse;background:#fffaf0;border:1px solid #ffe066;color:#2a7ae2;font-size:1em;border-radius:8px;overflow:hidden;">
            ...
            <tbody>
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Maintenance premium</td>
                    <td style="padding:8px;border:1px solid #ffe066;">1 an</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">950,00 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">1 200,00 €</td>
                </tr>
                <tr>
                    <td style="padding:8px;border:1px solid #ffe066;">Audits de sécurité</td>
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">150,00 €</td>
                </tr>
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Support expert 24/7</td>
                    <td style="padding:8px;border:1px solid #ffe066;">Incluse</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">0,00 €</td>
            ...
            <tfoot>
                <tr style="background:#ffe066;font-weight:bold;color:#222;">
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">950,00 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">1 550,00 €</td>
                </tr>
            </tfoot>
        </table>
        <div style="background:#fffaf0;border:1px solid #ffe066;border-radius:8px;padding:14px 18px;margin-top:14px;color:#2a7ae2;font-size:1em;text-align:left;">
            Cette offre inclut la maintenance premium, les audits de sécurité et le support expert. Le tarif “sans offre” correspond au prix standard si chaque service était acheté séparément. Idéal pour la tranquillité d’esprit et la performance de votre site.
        </div>
    </section>
