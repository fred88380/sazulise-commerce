...
<head>
    ...
    <meta name="description" content="Maintenance préventive et corrective pour sites web. Idéale pour les besoins courants, la sécurité, les mises à jour et les sauvegardes par Sazulis.">
    <meta name="keywords" content="maintenance site web, maintenance corrective, sauvegarde mensuelle, support technique web, sazulis, epinal, vosges">
    ...
    <script type="application/ld+json">
    {
      ...
      "description": "Maintenance régulière, mises à jour, sauvegardes et support technique pour assurer la stabilité et la sécurité de votre site internet.",
...
<main>
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                ...
                <div style="color:#2a7ae2;font-size:1.1em;font-weight:600;margin-top:4px;">Suivi régulier, mises à jour &amp; sécurité de vos infrastructures</div>
            </div>
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                Maintenance préventive et corrective pour sites web, idéale pour les besoins courants et la sécurité.<br>
                Maintenance régulière, mises à jour, sauvegardes et support technique pour assurer la stabilité de votre site.
            </div>
        </div>
    </section>
    ...
    <section style="max-width:700px;margin:2em auto 0;padding:20px;background:#f8f8f8;border-radius:10px;box-shadow:0 2px 8px #0001;">
        ...
        <table style="width:100%;border-collapse:collapse;background:#fffaf0;border:1px solid #ffe066;color:#2a7ae2;font-size:1em;border-radius:8px;overflow:hidden;">
            ...
            <tbody>
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Maintenance basic</td>
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">450,00 €</td>
                </tr>
                <tr>
                    <td style="padding:8px;border:1px solid #ffe066;">Sauvegardes mensuelles</td>
                ...
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Support technique par email</td>
                    <td style="padding:8px;border:1px solid #ffe066;">Incluse</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">0,00 €</td>
            ...
            <tfoot>
                <tr style="background:#ffe066;font-weight:bold;color:#222;">
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">350,00 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">590,00 €</td>
                </tr>
            </tfoot>
        </table>
        <div style="background:#fffaf0;border:1px solid #ffe066;border-radius:8px;padding:14px 18px;margin-top:14px;color:#2a7ae2;font-size:1em;text-align:left;">
            Cette offre inclut la maintenance basic, les sauvegardes mensuelles et le support technique par email. Le tarif “sans offre” correspond au prix standard si chaque service était acheté séparément. Idéal pour la sécurité et la stabilité de votre site.
        </div>
    </section>
