...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($product['name']) ?> Premium - Sazulis</title>
    <meta name="description" content="Découvrez notre solution e-commerce Next.js haut de gamme. Vitesse fulgurante, architecture réactive, catalogue sécurisé avec hébergement et SEO inclus par Sazulis.">
    <meta name="keywords" content="e-commerce next.js, boutique en ligne nextjs, developpeur react e-commerce, boutique ultra rapide, sazulis, epinal, vosges, site marchand de luxe">
    ...
    <script type="application/ld+json">
    {
      ...
      "@type": "Product",
      "name": "<?= htmlspecialchars($product['name']) ?> Premium",
      "image": "https://<?= $_SERVER['HTTP_HOST'] ?>/assets/img/e-commerce2.png",
      "description": "Boutique en ligne haut de gamme et ultra-rapide développée sous Next.js. Performance SSR optimisée pour le SEO, interface responsive sur-mesure et tunnels de conversion sécurisés.",
...
<main>
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                ...
                <div style="color:#2a7ae2;font-size:1.1em;font-weight:600;margin-top:4px;">Développement e-commerce Next.js moderne, rapide &amp; sécurisé</div>
            </div>
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                Développement de boutiques e-commerce Next.js modernes, rapides et sécurisées, avec hébergement et support technique expert.<br>
                Développement de boutiques e-commerce Next.js modernes, rapides et sécurisées, avec hébergement et support technique expert.
            </div>
        </div>
    </section>
    ...
    <section style="background: none; padding: 2em 0 1em 0;">
        <ul class="hero-devweb-list" style="display:flex;flex-wrap:wrap;justify-content:center;gap:2em;list-style:none;padding:0;margin:0 auto 0 auto;max-width:900px;">
            <li>Boutique Next.js sur-mesure</li>
            <li>Design responsive &amp; UX optimisée</li>
            <li>Paiement sécurisé &amp; gestion catalogue</li>
            <li>Hébergement 1 mois offert</li>
            <li>Support expert e-commerce</li>
        </ul>
    </section>
    ...
    <section style="max-width:700px;margin:2em auto 0;padding:20px;background:#f8f8f8;border-radius:10px;box-shadow:0 2px 8px #0001;">
        ...
        <table style="width:100%;border-collapse:collapse;background:#fffaf0;border:1px solid #ffe066;color:#2a7ae2;font-size:1em;border-radius:8px;overflow:hidden;">
            ...
            <tbody>
                ...
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">SEO payable une fois par développement</td>
        ...
        <div style="background:#fffaf0;border:1px solid #ffe066;border-radius:8px;padding:14px 18px;margin-top:14px;color:#2a7ae2;font-size:1em;text-align:left;">
            Nos offres regroupent tous les services essentiels pour votre site, à un tarif préférentiel. Vous bénéficiez d’un hébergement et d’un nom de domaine offerts pour un an, ainsi que trois mois de maintenance inclus. Le SEO est également pris en charge lors du développement. Le tarif “sans offre” correspond au prix standard si chaque service était acheté séparément, sans les avantages inclus. Nous avons conçu ces packs pour vous garantir simplicité, économies et tranquillité d’esprit, sans frais cachés.
        </div>
    </section>
