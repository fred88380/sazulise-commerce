...
$product = [
    ...
    'price' => 1316.98,
    'img' => '../../assets/img/vitrine-site.png',
    'ref' => 'site-vitrine-pack-starter-html',
];
...
<head>
    <meta charset="UTF-8">
    <title><?= htmlspecialchars($product['name']) ?> - Solution de Démarrage - Sazulis</title>
    <meta name="description" content="Propulsez votre activité avec le Pack Starter HTML pour site vitrine. Une solution web professionnelle, moderne, ultra-rapide et optimisée pour le référencement naturel à prix réduit.">
    <meta name="keywords" content="pack starter html, site vitrine pas cher, creation site internet de démarrage, site vitrine html5, developpement site web rapide, sazulis">
    ...
    <script type="application/ld+json">
    {
      ...
      "image": "https://<?= $_SERVER['HTTP_HOST'] ?>/assets/img/vitrine-site.png",
      "description": "Pack de démarrage HTML pour concevoir un site vitrine professionnel, fluide, sécurisé et nativement structuré pour Google.",
...
<main style="background:transparent;box-shadow:none;border-radius:0;margin-bottom:2em;">
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                Pack de démarrage HTML pour site vitrine professionnel, moderne, rapide et sécurisé.
            </div>
            <div style="margin-top:2em;display:flex;flex-direction:column;align-items:center;gap:0.5em;">
                <div style="display:flex;align-items:baseline;gap:1em;justify-content:center;flex-wrap:wrap;">
                    <span class="prix-barre" style="font-size:1.2em;color:#174a7c;text-decoration:line-through;font-weight:700;">4 326,87 €</span>
                    <span class="prix-promo" style="font-size:2em;font-weight:900;color:#d2691e;background:linear-gradient(90deg,#ffe9c6,#fffbe6 80%,#ffd700);padding:0.2em 0.8em;border-radius:1em;box-shadow:0 1px 8px #ffd70033;">
                        <?= number_format($product['price'], 2, ',', ' ') ?> € TTC
                    </span>
                    <span class="fiche-economie" style="color:#388e3c;font-weight:600;font-size:1em;margin-left:0.5em;">Économie : <?= number_format(4326.87 - 1316.98, 2, ',', ' ') ?> €</span>
                </div>
    ...
    <section style="background: none; padding: 2em 0 1em 0;">
        <ul class="hero-devweb-list" style="display:flex;flex-wrap:wrap;justify-content:center;gap:2em;list-style:none;padding:0;margin:0 auto 0 auto;max-width:900px;">
            ...
            <li>Technologie HTML5/CSS3 performante</li>
    ...
    <section style="background:#eaf4ff;border-radius:18px;padding:2em 1.5em;box-shadow:0 4px 24px rgba(42,122,226,0.08);margin:2em auto 2em auto;max-width:900px;">
        ...
        <p style="color:#222;font-size:1.05rem;line-height:1.6;">
            Développement de sites vitrine HTML5/CSS3 modernes, ultra-rapides et sécurisés, avec hébergement et support technique expert. Idéal pour les entreprises souhaitant une solution performante, fiable et évolutive.
        </p>
    </section>
