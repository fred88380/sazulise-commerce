...
<head>
    ...
    <meta name="description" content="Maintenance avancée et proactive pour entreprises. Sécurité renforcée, monitoring non-stop 24/7 et assistance prioritaire par Sazulis.">
    <meta name="keywords" content="maintenance business, maintenance informatique pro, monitoring 24/7, support technique entreprise, sazulis, epinal, vosges">
    ...
    <script type="application/ld+json">
    {
      ...
      "image": "https://<?= $_SERVER['HTTP_HOST'] ?>/assets/img/maintenance.jpg",
      "description": "Maintenance proactive, monitoring, sauvegardes fréquentes et assistance téléphonique pour garantir la continuité de service de votre entreprise.",
...
<main>
    <section class="hero-clean" style="background: transparent;">
        <div style="background: transparent; box-shadow: none; border-radius: 0; padding: 2.5em 0 2em 0; text-align: center;">
            <div style="display:flex;flex-direction:column;align-items:center;gap:10px;">
                ...
                <div style="color:#2a7ae2;font-size:1.1em;font-weight:600;margin-top:4px;">Suivi proactif, monitoring &amp; haute disponibilité pour professionnels</div>
            </div>
            ...
            <div class="hero-clean-desc" style="background: transparent; max-width:600px; margin:auto;">
                Maintenance avancée pour entreprises, sécurité renforcée, support prioritaire et interventions rapides.<br>
                Maintenance proactive, monitoring, sauvegardes fréquentes et assistance téléphonique pour garantir la continuité de service.
            </div>
        </div>
    </section>
    ...
    <section style="background: none; padding: 2em 0 1em 0;">
        <ul class="hero-devweb-list" style="display:flex;flex-wrap:wrap;justify-content:center;gap:2em;list-style:none;padding:0;margin:0 auto 0 auto;max-width:900px;">
            ...
            <li>Rapport détaillé mensuel</li>
        </ul>
    </section>
    ...
    <section style="max-width:700px;margin:2em auto 0;padding:20px;background:#f8f8f8;border-radius:10px;box-shadow:0 2px 8px #0001;">
        ...
        <table style="width:100%;border-collapse:collapse;background:#fffaf0;border:1px solid #ffe066;color:#2a7ae2;font-size:1em;border-radius:8px;overflow:hidden;">
            ...
            <tbody>
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Maintenance business</td>
                    <td style="padding:8px;border:1px solid #ffe066;">1 an</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">650,00 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">850,00 €</td>
                </tr>
                <tr>
                    <td style="padding:8px;border:1px solid #ffe066;">Monitoring 24/7</td>
                ...
                <tr style="background:#fffbe6;">
                    <td style="padding:8px;border:1px solid #ffe066;">Support téléphonique prioritaire</td>
                    <td style="padding:8px;border:1px solid #ffe066;">Incluse</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">0,00 €</td>
            ...
            <tfoot>
                <tr style="background:#ffe066;font-weight:bold;color:#222;">
                    ...
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">650,00 €</td>
                    <td style="padding:8px;border:1px solid #ffe066;text-align:right;">1 150,00 €</td>
                </tr>
            </tfoot>
        </table>
        <div style="background:#fffaf0;border:1px solid #ffe066;border-radius:8px;padding:14px 18px;margin-top:14px;color:#2a7ae2;font-size:1em;text-align:left;">
            Cette offre inclut la maintenance business, le monitoring 24/7 et le support téléphonique prioritaire. Le tarif “sans offre” correspond au prix standard si chaque service était acheté séparément. Idéal pour la tranquillité d’esprit et la continuité de votre activité.
        </div>
    </section>
