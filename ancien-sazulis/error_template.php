...
$basePath = ($basePath === '/' || $basePath === '.' || $basePath === null) ? '' : rtrim($basePath, '/');
...
<header class="topbar">
  <div class="topbar-logo">
    <a href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/index.php" class="brand">
      <img src="<?= htmlspecialchars($assetsBasePath, ENT_QUOTES, 'UTF-8') ?>/assets/img/sazulis-logo1.png" alt="Logo Sazulis">
    </a>
  </div>
  <nav class="topbar-nav">
    <a href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/index.php">Accueil</a>
    <a href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/pages/products.php">Boutique</a>
    <a href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/pages/contact.php">Contact</a>
    <a href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/pages/audit.php">Audit</a>
  </nav>
</header>
  ...
  <section class="error-wrap">
    <article class="error-card">
      ...
      <div class="error-actions">
        <a class="error-btn primary" href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/index.php">Retour a l'accueil</a>
        <a class="error-btn ghost" href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/pages/products.php">Aller a la boutique</a>
        <a class="error-btn ghost" href="<?= htmlspecialchars($basePath, ENT_QUOTES, 'UTF-8') ?>/pages/contact.php">Contacter le support</a>
      </div>
    </article>
  </section>
</main>
